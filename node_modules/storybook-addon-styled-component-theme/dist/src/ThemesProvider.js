...
var BaseComponent = function (_a) {
    var theme = _a.theme, Provider = _a.Provider, children = _a.children;
    return (React.createElement(Provider, { theme: theme, children: children }));
};
exports.ThemesProvider = recompose_1.compose(recompose_1.mapProps(function (props) {
    var CustomThemeProvider = props.CustomThemeProvider;
    var Provider = CustomThemeProvider ? CustomThemeProvider : styled_components_1.ThemeProvider;
    return __assign({}, props, { Provider: Provider });
}), recompose_1.withState("theme", "setTheme", null), recompose_1.withHandlers({
