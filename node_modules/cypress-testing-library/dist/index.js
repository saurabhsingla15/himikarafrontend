...
const commands = Object.keys(_domTestingLibrary.queries).map(queryName => {
  return {
    name: queryName,
    command: (...args) => {
      ...
      const queryImpl = _domTestingLibrary.queries[queryName];

      const baseCommandImpl = doc => {
        const container = (0, _utils.getContainer)(waitOptions.container || doc);
        return (0, _domTestingLibrary.waitForElement)(() => queryImpl(container, ...args), (0, _extends2.default)({}, waitOptions, {
          container
        }));
      };
